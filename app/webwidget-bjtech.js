...
var mybo = document.createElement('widgetbalesin');
...
function myJQueryCode() {
	...
	// Credentials
	var baseUrl = "https://94d38c48.ngrok.io";

	//---------------------------------- Add dynamic html bot content(Widget style) ----------------------------
	// You can also add the html content in html page and still it will work!
	var widgetbalesin = '<div class="chatCont" id="chatCont">'+
								'<div class="bot_profile">'+
									'<div class="bot_name">'+
										'<img src="" class="bot_p_img">'+
										'<h4 class="nametop">'+emailuser+'</h4>'+
	...
	$("widgetbalesin").html(widgetbalesin);
...
//------------------------------------ POSTBACK value from button in result_div -------------------------------------
	...
	function setUserResponse(val) {
		...
		var UserResponse = '<div class="msg right-msg"> \
								<div class="msg-img" style="background-image: url(https://raw.githubusercontent.com/pianbjtech/test_cdn/master/user-bot.png)"></div> \
	...
	function imageFn(email) {
		...
		$.ajax({
			...
			url: url,
			beforeSend: function() {
				$("img.bot_p_img").attr("src", "https://raw.githubusercontent.com/pianbjtech/test_cdn/master/snipper.gif");
			},
